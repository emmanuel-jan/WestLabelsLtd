...
$Target="../Upload/".basename($_FILES["image"]["name"]);
        ...
        if(empty($Title)||empty($Category)||empty($Post)||empty($Image)){
            ...
            redirect_to("AddNewBlog.php");
                 ...
                 $sql="UPDATE blogpost SET datetime='$DateTime',title='$Title',category='$Category',author='$Admin',image='$Image',post='$Post'
	...
	<div class="inner">
		...
		<span> 
            ...
            <?php 
                    ...
                    $query="SELECT * FROM blogpost WHERE id='$SearchQuery'";
            ...
            <form method="post" action="EditPost.php?Edit=<?php echo $SearchQuery; ?>" enctype="multipart/form-data">
                <div class="row gtr-uniform">
                    <div class="col-6 col-12-xsmall">
                        <input type="text" name="title" id="title" value="<?php echo $TitleToBeUpdated; ?>" placeholder="Enter Post Title" />
                    </div>
                    <div class="col-12">
                    <p>Existing Category:<i><?php echo $CategoryToBeUpdated; ?></i></p>
                    ...
                    <div class="col-12">
                        <textarea name="post" id="post" placeholder="Type your post here..." rows="6"><?php echo $PostToBeUpdated; ?></textarea>
                    </div>
                    <div class="col-12">
                        <ul class="actions">
                            <li><input type="submit" name="submit" value="Edit Post" class="primary" /></li>
